...
public class User extends HashMap<Integer, ProjectMembership> implements NamedEntity, Serializable {
    ...
    protected User(Environment environment, int id, String login, String name, Access access) {
        super();
     ...
     * @param access access
     */
    public User(Environment environment, String login, String name, Access access) {
